...
public class MKBanner extends FrameLayout implements OnPageChangeListener {
    public String tag = "banner";
    private int mIndicatorMargin = 0;
    private int mIndicatorWidth = 35;
    private int mIndicatorHeight = 17;
    private int mIndicatorSelectedWidth = 35;
    private int mIndicatorSelectedHeight = 17;
    ...
    private int mIndicatorSelectedResId = R.drawable.mk_selected_res;
    private int mIndicatorUnselectedResId = R.drawable.mk_unselected_res;
    private int mLayoutResId = R.layout.mkbanner;
    ...
    public MKBanner(Context context) {
        this(context, null);
    }

    public MKBanner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MKBanner(Context context, AttributeSet attrs, int defStyle) {
...
//        mIndicatorSelectedHeight = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_selected_height, indicatorSize);
        ...
        bannerBackgroundImage = typedArray.getResourceId(R.styleable.Banner_banner_default_image, R.drawable.mk_no_banner);
        typedArray.recycle();
    }
    ...
    public MKBanner isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public MKBanner setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public MKBanner setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public MKBanner setIndicatorGravity(int type) {
        switch (type) {
    ...
    public MKBanner setBannerAnimation(Class<? extends PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public MKBanner setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public MKBanner setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public MKBanner setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public MKBanner setBannerDescriptions(List<String> descriptions) {
        this.descriptions = descriptions;
        return this;
    }

    public MKBanner setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public MKBanner setImages(List<?> imageUrls) {
...
//        Log.i(tag,"currentItem: "+currentItem);
     ...
     * @return
     */
    public MKBanner setOnBannerListener(OnBannerListener listener) {
        this.listener = listener;
        return this;
    }

    public MKBanner setStartIndex(int index) {
