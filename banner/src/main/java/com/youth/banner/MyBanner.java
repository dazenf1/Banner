...
//        numIndicatorInside = (TextView) view.findViewById(R.id.numIndicatorInside);
    ...
    public MyBanner setBannerDescriptions(List<String> descriptions) {
...
//        indicatorInside.setVisibility(GONE);
    ...
    private void setTitleStyleUI() {
        ...
        if (titleHeight != -1) {
            RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, titleHeight);
...
//                numIndicatorInside.setText(position + "/" + count);
    ...
    public MyBanner setStartIndex(int index) {
