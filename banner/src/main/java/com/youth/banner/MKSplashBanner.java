...
public class MKSplashBanner extends FrameLayout implements OnPageChangeListener {
    public String tag = "banner";
    private int mIndicatorMargin = 0;
    private int mIndicatorWidth = 36;
    private int mIndicatorHeight = 20;
    private int mIndicatorSelectedWidth = 36;
    private int mIndicatorSelectedHeight = 20;
    ...
    private int mIndicatorSelectedResId = R.drawable.mk_sp_selected_res;
    private int mIndicatorUnselectedResId = R.drawable.mk_sp_unselected_res;
    private int mLayoutResId = R.layout.mksplashbanner;
    ...
    private TextView bannerTitle, descriptionText;
    ...
    public MKSplashBanner(Context context) {
        this(context, null);
    }

    public MKSplashBanner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MKSplashBanner(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView(final Context context, AttributeSet attrs) {
        ...
        FrameLayout.LayoutParams params = (LayoutParams) titleView.getLayoutParams();
        params.setMargins(0, ScreenWidth, 0, 0);
...
//        mIndicatorSelectedHeight = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_selected_height, indicatorSize);
    ...
    public MKSplashBanner isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public MKSplashBanner setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public MKSplashBanner setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public MKSplashBanner setIndicatorGravity(int type) {
        switch (type) {
    ...
    public MKSplashBanner setBannerAnimation(Class<? extends PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public MKSplashBanner setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public MKSplashBanner setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public MKSplashBanner setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public MKSplashBanner setBannerDescriptions(List<String> descriptions) {
        this.descriptions = descriptions;
        return this;
    }

    public MKSplashBanner setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public MKSplashBanner setImages(List<?> imageUrls) {
    ...
    public void update(List<?> imageUrls, List<String> titles, List<String> descriptions) {
        this.descriptions.clear();
        this.titles.addAll(descriptions);
        update(imageUrls, titles);
    }
...
//        Log.i(tag, ev.getAction() + "--" + isAutoPlay);
    ...
    class BannerPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            view.setPadding(0, 0, 0, getScreenHeight() - ScreenWidth);
            if (listener != null) {
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    public void onPageSelected(int position) {
        ...
        if (!isLoop) {
            Log.e("tagg", "lastPosition=" + lastPosition + ",position=" + position);
            indicatorImages.get(lastPosition).setImageResource(mIndicatorUnselectedResId);
            indicatorImages.get(lastPosition).setLayoutParams(Unselectedparams);
            indicatorImages.get(position).setImageResource(mIndicatorSelectedResId);
            indicatorImages.get(position).setLayoutParams(Selectedparams);
        } else {
        ...
        descriptionText.setText(descriptions.get(position - 1));
        if (position == 1) {
            bannerTitle.setTextColor(Color.parseColor("#2284EB"));
            descriptionText.setTextColor(Color.parseColor("#C2C2C2"));
            iv_finish.setVisibility(View.GONE);
        } else if (position == 2) {
            bannerTitle.setTextColor(Color.parseColor("#58B677"));
            descriptionText.setTextColor(Color.parseColor("#C2C2C2"));
            iv_finish.setVisibility(View.GONE);
        } else if (position == 3) {
            bannerTitle.setTextColor(Color.parseColor("#5795F9"));
            descriptionText.setTextColor(Color.parseColor("#C2C2C2"));
     ...
     * @return
     */
    public MKSplashBanner setOnBannerListener(OnBannerListener listener) {
        this.listener = listener;
        return this;
    }

    public MKSplashBanner setStartIndex(int index) {
